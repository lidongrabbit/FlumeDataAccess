 ...
 * partition.
 */
public class SimpleKafkaSink extends AbstractSink implements Configurable {

    private static final Logger logger = LoggerFactory.getLogger(SimpleKafkaSink.class);
   ...
   // @Override
    public void configure(Context context) {
        ...
        for (String key : params.keySet()) {
            ...
            key = key.trim();
            if (key.startsWith(com.asiainfo.ocdp.common.Constants.DEFAULT_KEY)) {
                // remove the prefix
                key = key.substring(com.asiainfo.ocdp.common.Constants.DEFAULT_KEY.length() + 1, key.length());
        ...
        String preprocessorClassName = context.getString(com.asiainfo.ocdp.common.Constants.PREPROCESSOR);
        ...
        if (messagePreProcessor == null) {
            ...
            topic = context.getString(com.asiainfo.ocdp.common.Constants.TOPIC, com.asiainfo.ocdp.common.Constants.DEFAULT_TOPIC);
            if (topic.equals(com.asiainfo.ocdp.common.Constants.DEFAULT_TOPIC)) {
                logger.warn("The Properties 'metadata.extractor' or 'topic' is not set. Using the default topic name" +
                		com.asiainfo.ocdp.common.Constants.DEFAULT_TOPIC);
            } else {
