...
import com.asiainfo.ocdp.beijing.source.BeijingMcSource;
import com.asiainfo.ocdp.socket.SocketUtil;

/**
 * Created by yangjing5 on 2016/4/22.
 */
public class McSocketAnalysisTask implements Runnable {
    private final static Logger logger = Logger.getLogger(McSocketAnalysisTask.class);
    ...
    public McSocketAnalysisTask( Socket socket){
        this.socketQueue = BeijingSocketServer.socketQueue;
        this.msgQueue = BeijingMcSource.msgQueue;
        this.socket = socket;
    }
