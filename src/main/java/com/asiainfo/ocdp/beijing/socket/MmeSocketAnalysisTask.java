...
import com.asiainfo.ocdp.beijing.source.BeijingMmeSource;
import com.asiainfo.ocdp.socket.SocketUtil;

/**
 * Created by yangjing5 on 2016/4/22.
 */
public class MmeSocketAnalysisTask implements Runnable {
    private final static Logger logger = Logger.getLogger(MmeSocketAnalysisTask.class);
    ...
    public MmeSocketAnalysisTask( Socket socket){
        this.socketQueue = BeijingSocketServer.socketQueue;
        this.msgQueue = BeijingMmeSource.msgQueue;
        this.socket = socket;
    }
